        ...
        <div class="container mx-auto p-6 bg-white rounded-lg shadow-lg mt-6">
            ...
            <ul class="list-disc pl-6 text-gray-700 mb-4">
                <li><strong>Student Information</strong>: Student ID, name, and attendance data (in or out of campus
                    status).</li>
                <li><strong>Guardian Information</strong>: Guardian’s name, contact information, and login credentials
                    for accessing the system.</li>
                <li><strong>Device and Log Data</strong>: Information related to the device used to access the system,
            ...
            <p class="text-gray-700 mb-4">We will not share, sell, or rent your personal information to third parties,
            ...
            <p class="text-gray-700 mb-4">We take reasonable measures to protect the personal information we collect.
            ...
            <p class="text-gray-700 mb-4">Parents can log in to their accounts to access and view the attendance status
                of their child. If you wish to update or delete your personal information, you can do so through your
            ...
            <p class="text-gray-700 mb-4">We retain your personal information only for as long as necessary to fulfill
            ...
            <p class="text-gray-700 mb-4">If you have any questions about this Privacy Policy or the ISUdD Attendance
